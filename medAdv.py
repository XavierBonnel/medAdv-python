...
|:__('|)___________________@|___(|__|__#( )___@|._____@|__@|_@|____________:|
     "|                              mp                                    /
''')
        print("You approach an old elf. He tells you about his youth as a great warrior in the century war he participates against the orks to protect the forest of his ancestors\n")
